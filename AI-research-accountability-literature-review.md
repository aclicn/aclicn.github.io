...
本文保留原稿的統整觀點與實驗室原則討論。逐篇文獻介紹與評論已自本文移除；書目與摘要請見獨立的[註解書目](annotated-bibliography-AI-accountability-epistemics.md)。[英文摘要](AI-research-accountability-literature-review-en.md)另頁提供，篇幅較精簡。

本次調整為文件分拆與編排，並未重新查核原稿的文獻主張、數據或引文。原稿的統整範圍為 39 篇；獨立註解書目保留 40 篇，包含原統整稿因未取得全文與摘要而排除的 Brown & Marsden (2026)。
