...
本文探討研究者在廣泛使用 AI 的同時，如何保有自己的理解與判斷，並為研究內容承擔責任。文獻評述涵蓋作者身分與主張的可辯護性、AI 使用與揭露政策，以及理解的錯覺、認知卸載、過度依賴和學習受損等風險；並比較支持與質疑「研究各階段皆可使用 AI」的論點，說明產出表現提升與研究者真正理解之間的差別。進一步的討論聚焦於實驗室原則如何落實，包括保密界線、使用紀錄、引用與分析的驗證、期刊規範，以及學生與博士後的能力養成，最後提出可供採用的實施說明。
